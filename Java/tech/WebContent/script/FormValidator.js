                ...
                switch (options.type) {
                    case 'minValue':
                        if (targetValue < options.value) {
                            ...
                            $("#" + messageTargetId).removeClass("rightmessage");
                            $("#" + messageTargetId).addClass("errormessage");
                            isValidate = false;
                        }
                        else {
                            $("#" + messageTargetId).html(rightMessage);
                            $("#" + messageTargetId).removeClass("errormessage");
                            $("#" + messageTargetId).addClass("rightmessage");
                            isValidate = true;
                        }
                        break;
                    case 'maxValue':
