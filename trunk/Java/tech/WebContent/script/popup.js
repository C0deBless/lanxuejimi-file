...
Popup.prototype = {
	...
	build : function() {
		...
		var mainBox = '<div id="dialogBox" style="border:1px solid '
				...
				+ this.color.bColor + '">';
		if (this.config.isHaveTitle) {
			mainBox += '<tr height="30" bgcolor="'
					+ this.color.tColor
					+ '"><td><table style="-moz-user-select:none;height:30px;" width="100%" border="0" cellpadding="0" cellspacing="0" ><tr><td width="6" height="24"></td><td id="dialogBoxTitle" style="color:'
					+ this.color.wColor
					+ ';font-size:14px;">'
					+ this.info.title
					+ '&nbsp;</td><td id="dialogClose" width="20" align="right" valign="middle">'
		...
		mainBox += '<tr style="height:'
				+ this.config.height
				+ 'px" valign="top"><td id="dialogBody" style="position:relative;"></td></tr></table></div><div id="dialogBoxShadow" style="display:none;z-index:'
				+ baseZIndex + ';"></div>';
	...
	lastBuild : function() {
		var confirm = '<div style="width:100%;height:100%;text-align:center;"><div style="margin:20px 20px 0 20px;font-size:14px;line-height:16px;color:#000000;">'
				...
				+ '</div><div style="margin:20px;"><input id="dialogOk" type="button" class="btn" value=" 确定 "/>&nbsp;<input id="dialogCancel" type="button" class="btn" value=" 取消 "/></div></div>';
		var alert = '<div style="width:100%;height:100%;text-align:center;"><div style="margin:20px 20px 0 20px;font-size:14px;line-height:16px;color:#000000;">'
				+ this.info.alertCon
				+ '</div><div style="margin:20px;"><input id="dialogYES" type="button" class="btn" value=" 确定 "/></div></div>';
		var baseZIndex = 10001 + this.info.overlay * 10;
		...
		if (this.config.contentType == 1) {
			...
			Event.observe(G('dialogYES'), "click", this.forCallback
					.bindAsEventListener(this), false)
		}
	},
	reBuild : function() {
...
function ShowDom(dom, title, width, height) {
	if (width == null) {
		width = 340
	}
	;
