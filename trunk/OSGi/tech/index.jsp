...
<link href="<%=request.getContextPath()+"/style/menu.css" %>" rel="stylesheet" type="text/css" media="screen" />
<link href="<%=request.getContextPath()+"/style/layout.css" %>" rel="stylesheet" type="text/css" media="screen" />
...
<body>
	<div id="wrapper">
        ...
        <div id="containerHolder">
			<div id="container">
				<div id="left">
	        		<div id="sidebar" onmouseout="javascript:if(menuflag!=0){hideMenu('net');hideMenu('flash');hideMenu('java');hideMenu('webfront');hideMenu('mobile');hideMenu('database');}">
	                	<ul class="sideNav">
	                    	<li><a href="javascript:void(0);" onmouseover="showMenu('net');">.NET</a></li>
	                    	<li><a href="javascript:void(0);" onmouseover="showMenu('java');">JAVA</a></li>
	                    	<li><a href="javascript:void(0);" onmouseover="showMenu('flash');">Flash</a></li>
	                    	<li><a href="javascript:void(0);" onmouseover="showMenu('webfront');">Web前端</a></li>
	                    	<li><a href="javascript:void(0);" onmouseover="showMenu('mobile');">移动应用</a></li>
	                    	<li><a href="javascript:void(0);" onmouseover="showMenu('database');">数据库</a></li>
	                    ...
	                    <!-- // .sideNav -->
                           ...
                           <h2 style="display:none;"><a href="javascript:void(0);">Dashboard</a> &raquo; <a href="#" class="active">Print resources</a></h2>
        ...
        <!-- // #containerHolder -->        
        <p id="footer">Feel free to use and customize it. Credit is appreciated.</p>
    </div>
    <!-- // #wrapper -->
		<div class="menu_group" id="submenu_net" onmouseover="showMenu('net');"  onmouseout="hideMenu('net');">
			<ul>
		...
		<div class="menu_group" id="submenu_java" onmouseover="showMenu('java');" onmouseout="hideMenu('java');">
			<ul>
		...
		<div class="menu_group" id="submenu_flash" onmouseover="showMenu('flash');" onmouseout="hideMenu('flash');">
			<ul>
		...
		<div class="menu_group" id="submenu_webfront" onmouseover="showMenu('webfront');" onmouseout="hideMenu('webfront');">
			<ul>
		...
		<div class="menu_group" id="submenu_mobile" onmouseover="showMenu('mobile');" onmouseout="hideMenu('mobile');">
			<ul>
		...
		<div class="menu_group" id="submenu_database" onmouseover="showMenu('database');" onmouseout="hideMenu('database');">
			<ul>
