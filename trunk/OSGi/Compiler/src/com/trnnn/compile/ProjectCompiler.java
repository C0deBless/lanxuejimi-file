...
import com.trnnn.io.FileParser;
...
public class ProjectCompiler {
	...
	public ProjectCompiler(String projectPath,String projectName){
		...
		this.sourceFiles=this.fileParser.getFiles(new File(projectPath),new ArrayList<File>(),"java");
		// init classpath
		this.classpath="";
		List<File> tmpfiles=this.fileParser.getFiles(new File(projectPath), new ArrayList<File>(), "jar");
	...
	public void compile(boolean outputJar) throws Exception {
		...
		//System.setProperty("java.home",	"C:\\Program Files\\Java\\jdk1.6.0_24\\");
		...
		Iterable<String> options = Arrays.asList("-d", fullTargetPath,"-classpath","D:\\Java EE 5\\javaee.jar;"+this.classpath);
		Iterable<? extends JavaFileObject> compilationUnits = fileManager
				.getJavaFileObjectsFromStrings(this.prepareSourceFilePath(sourceFiles));//Arrays.asList("E:\\开发项目\\Java\\CompileTest\\src\\com\\trnnn\\compile\\Main.java"));
	...
	public static void main(String[] args) throws Exception{
		ProjectCompiler compiler=new ProjectCompiler("D:\\webtest\\","b2cccc");
